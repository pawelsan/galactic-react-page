...
const ArchivesPage = () => {
  ...
  const suggestions = planets.filter(
    (planet) =>
  ...
  const currentPlanets = !suggestions.toString()
    ? planets.slice(indexOfFirstPlanet, indexOfLastPlanet)
    : suggestions.slice(indexOfFirstPlanet, indexOfLastPlanet);
  ...
  const add = (a, b) => a + b;
  const populationList = planets
    .map((planet) => planet.population * 1)
      ...
      <div className="container">
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item">Galactic Archives</li>
          </ol>
        </nav>
      </div>
            ...
            {error ? (
              ...
              <div className="d-flex flex-column align-items-center">
                ...
                {loading ? (
                  ...
                  <div className="d-flex flex-column align-items-center">
                    <p>
                      Currently there are {planets.length} planets, moons, and
                      asteroids in the archives
                    </p>
                    <p>
                      The total humanoid population of these objects is
                      approximately {(populationSum / 1000000000000).toFixed(3)}{" "}
                      trillion
                    </p>
                  </div>
                )}
          ...
          <div className="row no-gutters mt-5 d-flex flex-column align-items-center justify-content-around">
            <div className="col-md-6">
              ...
              <PaginationNav
                ...
                totalPosts={
                  !suggestions.toString() ? planets.length : suggestions.length
                }
                paginate={paginate}
              />
            </div>
