                ...
                <div className="col-md-4">
                    ...
                    >
                        <div className="card mt-2">
                            ...
                            <img src={require(`../images/${planet.terrain.split(', ').filter(terrain => terrainPictures.includes(terrain))[0]}.jpg`)} alt="landscape" className="card-img-top" />
